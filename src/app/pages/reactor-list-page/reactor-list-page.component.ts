  ...
  reactors: ReactorModel[] = [
    {
      ...
      reactorCoreTemperature: [{ time: 1, value: 500, status: Status.inRange }, {time: 2,value: 121, status: Status.inRange},
        { time: 3, value: 11, status: Status.outOfRange }, { time: 4, value: 640, status: Status.critical },
        {time: 5, value: 600, status: Status.critical}, { time: 6, value: 111, status: Status.inRange },
        { time: 7, value: 121, status: Status.inRange }, { time: 8, value: 21, status: Status.outOfRange }],
      reactorPowerProduction: [{ time: 1, value: 500, status: Status.inRange }, { time: 2,
        value: 121,status: Status.inRange},{ time: 3, value: 11, status: Status.outOfRange }, { time: 4, value: 640, status: Status.critical },
        { time: 5,value: 600,status: Status.critical}, { time: 6, value: 111, status: Status.inRange },
        { time: 7, value: 121, status: Status.inRange }, { time: 8, value: 21, status: Status.outOfRange }],
      links:[{label: 'Link 1', href: 'https://google.com'}, {label: 'Link 2', href: 'https://google.com'}],
    },
    {
      id: '2', name: 'Reactor 2',
      description: 'Lorem ipsum dolor sit amet consectetur. Adipiscing non pulvinar placerat lorem ullamcorper magna. Pulvinar bibendum enim.',
      status: { coreTempStatus: Status.inRange, powerProdStatus: Status.outOfRange },
      reactorCoreTemperature: [{ time: 1, value: 500, status: Status.inRange }, { time: 2,
        value: 121,status: Status.inRange},{ time: 3, value: 11, status: Status.outOfRange }, { time: 4, value: 331, status: Status.critical },
      ...
      reactorPowerProduction: [{ time: 1, value: 111, status: Status.inRange }, { time: 2,value: 121,status: Status.inRange},
        { time: 3, value: 11, status: Status.outOfRange }, { time: 4, value: 331, status: Status.critical }, {time: 5, value: 211,status: Status.inRange
        }],
      links:[{label: 'Link 1', href: 'https://google.com'}, {label: 'Link 2', href: 'https://google.com'}]
    }
  ]
